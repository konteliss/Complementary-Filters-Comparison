...
public class Thesis_Version_2 extends PApplet {
...
public void draw()  {
  ...
  try {
    ...
    if (type.equals("DEL:")) {
        ...
        total_time = PApplet.parseFloat(dataval);
       ...
       */ 
        ...
        String data[] = split(dataval, ',');
        x_fil_hard_21 = PApplet.parseFloat(data[0]);
        y_fil_hard_21 = PApplet.parseFloat(data[1]);
        z_fil_hard_21 = PApplet.parseFloat(data[2]);
        
      } else if (type.equals("H51:")) {
        String data[] = split(dataval, ',');
        x_fil_hard_51 = PApplet.parseFloat(data[0]);
        y_fil_hard_51 = PApplet.parseFloat(data[1]);
        z_fil_hard_51 = PApplet.parseFloat(data[2]);
        
      } else if (type.equals("H11:")) {
        String data[] = split(dataval, ',');
        x_fil_hard_11 = PApplet.parseFloat(data[0]);
        y_fil_hard_11 = PApplet.parseFloat(data[1]);
        z_fil_hard_11 = PApplet.parseFloat(data[2]);
        
      } else if (type.equals("H22:")) {
        String data[] = split(dataval, ',');
        x_fil_hard_22 = PApplet.parseFloat(data[0]);
        y_fil_hard_22 = PApplet.parseFloat(data[1]);
        z_fil_hard_22 = PApplet.parseFloat(data[2]);
        
      } else if (type.equals("H52:")) {
        String data[] = split(dataval, ',');
        x_fil_hard_52 = PApplet.parseFloat(data[0]);
        y_fil_hard_52 = PApplet.parseFloat(data[1]);
        z_fil_hard_52 = PApplet.parseFloat(data[2]);
        
      } else if (type.equals("H12:")) {
        String data[] = split(dataval, ',');
        x_fil_hard_12 = PApplet.parseFloat(data[0]);
        y_fil_hard_12 = PApplet.parseFloat(data[1]);
        z_fil_hard_12 = PApplet.parseFloat(data[2]);
        
      }
      
      datavalprev = PApplet.parseFloat(dataval) ;
 ...
 if(j <= speed_index - 1  ){j = lines.length - 1;}
  ...
  fill(249, 250, 50);
  text("Gyroscope", (int) width/7.0f - 60, 250);
  text(gyrStr, (int) (width/7.0f) - 40, 275);

  fill(56, 140, 206);
  text("Accelerometer", (int) 2*width/7.0f - 60, 250);
  text(accStr, (int) 2*width/7.0f - 30, 275); 
  
  fill(83, 175, 93);
  text("Software Combination", (int) (3.0f*width/7.0f) - 100, 250);
  text(filStr, (int) (3.0f*width/7.0f) - 20, 275);
 ...
 // text("Time interval", (int) width/7.0 - 50, 100);
  ...
  fill(128, 0, 128);
  text("Total virtual time elapsed", (int) width/7.0f - 50, 150);
  text(total_timeStr, (int) (width/7.0f) - 30, 175);

  fill(83, 170, 93);
  text("1st Order τ=2", (int) (4.0f*width/7.0f - 115) , height/2 -  350);
  text(fil_hard_21_Str, (int) (4.0f*width/7.0f) - 50   ,  height/2 - 325);
  
  fill(83, 170, 93);
  text("1st Order τ=5", (int) (5.0f*width/7.0f) -115, height/2 - 350);
  text(fil_hard_51_Str, (int) (5.0f*width/7.0f) -50 ,  height/2 - 325 );
  
  fill(83, 170, 93);
  text("1st Order τ=10", (int) (6.0f*width/7.0f) - 115, height/2 -350);
  text(fil_hard_11_Str, (int) (6.0f*width/7.0f) - 50  ,  height/2 - 325);
  
  fill(83, 230, 93);
  text("2nd Order fc=79mHz", (int) (4.0f*width/7.0f) -125 , height/2 + 25);
  text(fil_hard_22_Str, (int) (4.0f*width/7.0f) - 50   ,  height/2 + 55);
  
  fill(83, 230, 93);
  text("2nd Order fc=31.8mHz", (int) (5.0f*width/7.0f) - 115, height/2 + 25);
  text(fil_hard_52_Str, (int) (5.0f*width/7.0f) - 50  ,  height/2 + 55);
  
  fill(83, 230, 93);
  text("2nd Order fc=15.9mHz", (int) (6.0f*width/7.0f) - 70, height/2 + 25);
  text(fil_hard_12_Str, (int) (6.0f*width/7.0f) - 50  , height/2 + 55);
 ...
 public void keyPressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#0095C9", "--stop-color=#FFC503", "Thesis_Version_2" };
    if (passedArgs != null) {
